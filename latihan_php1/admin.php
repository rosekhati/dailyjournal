...
<body>
  ...
  <footer class="text-center p-5 bg-danger-subtle">
    <div>
      <a href="https://www.instagram.com/seseane14"><i class="bi bi-instagram h2 p-2 text-dark"></i></a>
      <a href="https://twitter.com/udinusofficial"><i class="bi bi-twitter h2 p-2 text-dark"></i></a>
      <a href="https://wa.me/+6289509012858"><i class="bi bi-whatsapp h2 p-2 text-dark"></i></a>
    </div>
    <div>Rosekhati &copy; 2023</div>
  </footer>
  <!-- footer end -->
