...
<body>
  ...
  <section id="aboutme" class="text-center p-5 bg-danger-subtle">
    <div class="container">
      <div class="d-sm-flex align-items-center justify-content-center">
        <div class="p-3">
          <img src="img/rosekhati.jpg" class="rounded-circle border shadow" width="300" />
        </div>
        <div class="p-md-5 text-sm-start">
          <h3 class="lead">A11.2023.15496</h3>
          <h1 class="fw-bold">Rosekhati</h1>
  ...
  <footer id="footer" class="text-center p-5">
    <div>
      <a href="https://www.instagram.com/seseane14"><i class="bi bi-instagram h2 p-2"></i></a>
      <a href="https://twitter.com/udinusofficial"><i class="bi bi-twitter h2 p-2"></i></a>
      <a href="https://wa.me/+6289509012858"><i class="bi bi-whatsapp h2 p-2"></i></a>
    </div>
    <div>Rosekhati &copy; 2024</div>
  </footer>
  <!-- footer end -->
